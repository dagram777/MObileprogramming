...
import 'package:flutter_application_9/Presentaion/State/App.dart';
...
void main() {
  ...
  UserRepository userRepository = UserRepository(UserDataProvider());

  runApp(MyApp(commentRepository, courseRepository, userRepository));
  //runApp(ChangeNotifierProvider(create: (_) => SchoolAppState(), child: App()));
}
...
class MyApp extends StatelessWidget {
  ...
  MyApp(this.commentRepository, this.courseRepository, this.userRepository);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(lazy: false, create: (context) => UserBloc(userRepository)),
